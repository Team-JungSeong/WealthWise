        ...
        {currentStep === 3 && (
          <FormContainer>
            ...
            <div>
              <h3>분석 결과</h3>
              <p>
                초기 투자금 {formatCurrency(parseInt(initialAmount))}와 월{" "}
                {formatCurrency(parseInt(monthlyContribution))}의 적립식 투자로
