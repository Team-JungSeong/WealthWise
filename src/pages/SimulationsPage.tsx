  ...
  return (
    <Layout>
      <PageHeader>
        ...
        <PageSubtitle>
          다양한 금융 상황을 시뮬레이션하여 최적의 의사결정을 내리는 데 도움을 받으세요.
          미래 재정 상태를 예측하고 목표 달성을 위한 계획을 세워보세요.
        </PageSubtitle>
      </PageHeader>
      ...
      <SimulationsGrid>
        <SimulationCard variant="elevated">
          ...
          <SimulationDescription>
            수입과 지출을 분석하여 최적의 예산 계획을 수립합니다.
            불필요한 지출을 줄이고 저축을 늘리는 방법을 찾아보세요.
          </SimulationDescription>
          <Link to="/simulations/budget">
            <Button variant="primary" isFullWidth>시작하기</Button>
          </Link>
        </SimulationCard>
        ...
        <SimulationCard variant="elevated">
          ...
          <SimulationDescription>
            다양한 투자 방식과 기간, 수익률을 설정하여 미래 자산 가치를 예측해봅니다.
            정기 적립식, 일시 투자 등 다양한 투자 방식의 결과를 비교해 보세요.
          </SimulationDescription>
        ...
        <SimulationCard variant="elevated">
          ...
          <SimulationDescription>
            다양한 대출 조건과 상환 방식에 따른 총 비용과 월 상환액을 계산합니다.
            주택 대출, 개인 대출 등 다양한 대출 상품의 비용을 비교해 보세요.
          </SimulationDescription>
