...
const posts = [
  {
    ...
    excerpt:
      "주식 투자를 시작하려고 하는데 어디서부터 시작해야 할지 모르겠습니다. 초보자가 시작하기 좋은 방법이나 조언 부탁드립니다.",
    date: "2023-09-20",
    author: {
      id: "user1",
      name: "김투자",
  ...
  },
  {
    ...
    title: "학자금 대출 상환 전략",
    excerpt:
      "대학 졸업 후 학자금 대출을 가장 효과적으로 상환하는 방법이 궁금합니다. 원리금 균등 상환과 원금 균등 상환 중 어떤 방식이 더 유리할까요?",
    date: "2023-09-18",
    author: {
      id: "user2",
      name: "이대출",
  ...
  },
  {
    ...
    excerpt:
      "아직 30대 초반이지만 은퇴 준비를 시작하려고 합니다. 어떤 금융 상품을 활용하는 것이 좋을까요? 연금 저축? IRP? 추천 부탁드립니다.",
    date: "2023-09-15",
    author: {
      id: "user3",
      name: "박미래",
  ...
  },
  {
    ...
    title: "효과적인 가계부 작성법",
    excerpt:
      "가계부를 작성하려고 하는데 어떤 방식으로 해야 효과적인가요? 앱을 사용하시나요 아니면 엑셀이나 수기로 작성하시나요?",
    date: "2023-09-12",
    author: {
      id: "user4",
      name: "최예산",
  ...
  },
  {
    ...
    excerpt:
      "현재 전세 계약이 만료되어 갱신 또는 이사를 고민 중입니다. 전세, 월세, 매매 중 어떤 선택이 재정적으로 더 유리할까요?",
    date: "2023-09-10",
    author: {
      id: "user5",
      name: "정주택",
  ...
  return (
    <Layout>
      <PageHeader>
        ...
        <PageSubtitle>
          재정 관련 질문을 하고 다른 사용자들의 경험과 조언을 얻으세요. 모두가
          함께 성장하는 금융 커뮤니티에 참여하세요.
        </PageSubtitle>
      </PageHeader>
            ...
            <Sidebar>
              <div style={{ marginBottom: "20px" }}>
                <Card variant="elevated">
                  ...
                  <p>
                    금융 조언은 참고용으로만 활용하시고, 중요한 결정은 전문가와
                    상담하세요.
                  </p>
