...
const expertsMockData = [
  {
    ...
    specialties: [
      LearningCategory.Investing,
      LearningCategory.Retirement,
      LearningCategory.TaxPlanning,
    ],
  },
  {
    id: "2",
    ...
    specialties: [
      LearningCategory.RealEstate,
      LearningCategory.Investing,
      LearningCategory.DebtManagement,
    ],
  },
  {
    id: "3",
  ...
  },
  {
    ...
    specialties: [
      LearningCategory.Investing,
      LearningCategory.AdvancedInvesting,
      LearningCategory.BasicFinance,
    ],
  },
  {
    id: "5",
    ...
    specialties: [
      LearningCategory.DebtManagement,
      LearningCategory.Budgeting,
      LearningCategory.Saving,
    ],
  },
  {
    id: "6",
...
const ExpertsPage: React.FC = () => {
  ...
  const filteredExperts = expertsMockData.filter((expert) => {
    ...
    if (
      ...
      !expert.specialties.includes(selectedSpecialty as LearningCategory)
    ) {
      return false;
    }
  ...
  return (
    <Layout>
      <PageHeader>
        ...
        <PageSubtitle>
          당신의 재정 목표 달성을 위해 전문가의 맞춤형 상담을 받아보세요. 각
          분야 최고의 전문가들이 실질적인 도움을 드립니다.
        </PageSubtitle>
      </PageHeader>

      <FiltersContainer>
        <SearchContainer>
          <FilterLabel>검색어 입력</FilterLabel>
          <Input
        ...
        <FilterGroup>
          ...
          >
            ...
            <option value={LearningCategory.AdvancedInvesting}>
              고급 투자
            </option>
              ...
              <ExpertHeader>
                ...
                <ExpertInfo>
                  ...
                  <RatingContainer>
                    ...
                    <ReviewCount>
                      ({expert.rating} / {expert.reviewCount}개 리뷰)
                    </ReviewCount>
                  </RatingContainer>
              ...
              <SpecialtiesList>
                {expert.specialties.map((specialty) => (
                  <SpecialtyTag key={specialty}>
                    ...
                    {specialty === LearningCategory.DebtManagement &&
                      "부채 관리"}
                    {specialty === LearningCategory.Investing && "투자"}
                    {specialty === LearningCategory.AdvancedInvesting &&
                      "고급 투자"}
